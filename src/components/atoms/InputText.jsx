...
export default function InputText(props) {
  ...
  return (
    <div className='relative w-full flex items-center'>
      ...
      <textarea type="text" value={text} onChange={(e) => handleChange(e)} onKeyDown={(e) => e.key==='Enter'? submitHandler(e) : null } className={`w-full rounded-md p-2 px-4 duration-200 text-black  ${loading ? 'primary-bg' : 'bg-gray-50'}` } disabled={loading} placeholder={`${loading ? 'Loading...': 'Type a message'}`}/>
