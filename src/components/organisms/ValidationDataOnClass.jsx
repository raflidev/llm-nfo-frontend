                  ...
                  <div className="border border-black rounded p-4">
                    <h1 className='font-semibold'>{cqItem[0]}</h1>
                    {
                      cqItem[1].map((item, index) => {
                        return (
                          <div key={indexCQ+"-"+index} className='flex space-x-3 items-center'>
                            {!saveItem[indexCQ][index] ?
                              <textarea className='flex w-full bg-transparent border border-white p-1 rounded mt-4' value={item+indexCQ+"-"+index} onChange={(e) => changeHandle(e, indexCQ, index)} />
                            :
                              <textarea className='flex w-full bg-transparent border border-white p-1 rounded mt-4' value={item+indexCQ+"-"+index} disabled />
                            }
                            {!saveItem[indexCQ][index] ? 
