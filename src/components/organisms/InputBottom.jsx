...
export default function InputBottom(props) {
  const { setText, text, handleChange, submitHandler, loading } = props
  return (
    <div className='fixed bottom-5 w-11/12 md:w-10/12'>
      <div className='flex justify-center'>
        <div className='flex w-full md:w-1/2'>
          <InputText setText={setText} text={text} handleChange={handleChange} loading={loading} submitHandler={submitHandler} />
